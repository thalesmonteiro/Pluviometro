...
INICIO
	...
	MOVWF	TRISA	
	MOVLW	B'11111111'     ;CONFIGURA TODAS AS PORTAS DO TRISB (PINOS)
	MOVWF	TRISB	
...
MAIN 
	...
	CALL	CONVERTE_ASCII_LCD  ;CONVERTE OS VALORES DE BUFFER_H e BUFFER_L PARA EXIBIÇÃO NO LCD
