...
EXIBE_MENU_HOME  ;EXIBE A TELA INICIAL
    ...
    BCF	    RS
    MOVLW   0X97          ; DEFINE O CURSOR PARA LINHA 0
    CALL    ESCREVE
    BSF	    RS	
    ...
    CALL    ENDERECO_DIA ;RETORNA EM ENDERECO_HIGH E ENDERECO_LOW 
    CALL    ESCRITA_I2C_EEPROM
...
LEITURA_I2C_EEPROM   ;LEITURA DE UM ENDERECO QUALQUER, RETORNA OS 2 BYTES
	CALL	START_BIT
	CALL	AGUARDA_I2C
	BANK0
